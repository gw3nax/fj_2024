...
public class JwtService {
    ...
    private static final long TOKEN_EXPIRATION = 10 * 60 * 1000L; // 10 минут
    private static final long REMEMBER_ME_EXPIRATION = 30 * 24 * 60 * 60 * 1000L; // 30 дней
    ...
    public String generateToken(UserDetails userDetails, boolean rememberMe) {
        ...
        long expirationTime = rememberMe ? REMEMBER_ME_EXPIRATION : TOKEN_EXPIRATION;
