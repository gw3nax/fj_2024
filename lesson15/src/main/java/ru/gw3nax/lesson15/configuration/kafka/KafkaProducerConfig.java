...
public class KafkaProducerConfig {
    ...
    @Bean
    public DefaultKafkaProducerFactory<String, PayloadDto> kafkaProducerFactory() {
    ...
    @Bean
    public KafkaTemplate<String, PayloadDto> kafkaTemplate(DefaultKafkaProducerFactory<String, PayloadDto> kafkaProducerFactory) {
